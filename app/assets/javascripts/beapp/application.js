//= require jquery
//= require bootstrap
//= require beapp/popper
//= require beapp/scrollreveal
//= require beapp/parallax
//= require beapp/jquery.magnific-popup
//= require beapp/imgfix
  ...
  $(window).on('load', function() {
    ...
    $(".loader-wrapper").animate({
      ...
      setTimeout(function(){
        ...
        if($('.parallax').length){
          $('.parallax').parallax({
            imageSrc: image-url('photos/parallax.jpg'),
            zIndex: '1'
          });
        }
