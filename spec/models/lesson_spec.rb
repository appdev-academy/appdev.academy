...
RSpec.describe Lesson, type: :model do
  before :all do
    ...
    @screencast = FactoryGirl.create(:screencast, topic: topic)
  end
  
  it 'should have a valid factory' do
    expect(FactoryGirl.create(:lesson, screencast: @screencast)).to be_valid
  end
  ...
  context 'validations' do
    ...
    context 'fields' do
      subject { FactoryGirl.create(:lesson, screencast: @screencast) }
  ...
  context 'set default position on create' do
    it 'should set position to be last' do
      Lesson.destroy_all
      lesson1 = FactoryGirl.create(:lesson, screencast: @screencast)
      lesson2 = FactoryGirl.create(:lesson, screencast: @screencast)
      lesson3 = FactoryGirl.create(:lesson, screencast: @screencast)
